...
\begin{document}
	...
	\begin{table}[H]
		...
		\caption{Academic Achievements}\vskip -1.5ex
		...
		\begin{tabular}{@{\,}r <{\hskip 2pt} !{\foo} >{\raggedright\arraybackslash}p{15cm}}
			...
			2016 & Zonal Winner in Braintech 2017 \\
			...
			2014 - 2017 & \textbf{Google Admin} system Administration for Institute \\
			2014 - 2016 & Technical Event and Placement Coordinator \\
